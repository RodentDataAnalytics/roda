classdef config_place_avoidance < base_config
    ...
    properties(Constant)        
        ...
        FUNCTION_VARIANCE = function_wrapper('Variance', '@(x) var(x)');
        ...
        FEATURE_VAR_LOG_RADIUS = trajectory_feature('log_vR12', 'Log variance radius  ', 'trajectory_radius', 1, ...
            {'CENTRE_X', 'CENTRE_Y', 'ARENA_R'}, ...
            'TransformationFunc', config_place_avoidance.FUNCTION_LOG_NEG, ...
            'AveragingFunc', config_place_avoidance.FUNCTION_VARIANCE );        
        ...
        FEATURE_SHOCK_RADIUS = trajectory_feature('R_s', 'Shock radius', 'trajectory_event_radius', 1, ...
            {'CENTRE_X', 'CENTRE_Y', 'ARENA_R'}, ...
            config_place_avoidance.POINT_STATE_SHOCK );
        FEATURE_AVG_ANG_VELOCITY_ARENA = trajectory_feature('V_ang_A', 'Average angular velocity (arena)', 'trajectory_angular_velocity', ...
            1, {'CENTRE_X', 'CENTRE_Y'});
        FEATURE_VAR_ANG_VELOCITY_ARENA = trajectory_feature('Var_Vang_A', 'Variance angular velocity (arena)', 'trajectory_angular_velocity', ...
            2, {'CENTRE_X', 'CENTRE_Y'});                                     
        ...
        DATA_REPRESENTATION_ARENA_ANGULAR_SPEED_PROFILE = data_representation('Angular speed profile (arena)', base_config.DATA_TYPE_FUNCTION, 'trajectory_angular_speed_profile', 1, {'CENTRE_X', 'CENTRE_Y'}, 'DataRepresentation', config_place_avoidance.DATA_REPRESENTATION_ARENA_COORD);         
    ...
    methods        
        function inst = config_place_avoidance(name, varargin)
            ...
            [prop, feat, feat_clus] = process_options(varargin, 'Properties', {}, ...         
            ...
            inst@base_config(name, ...                
               ...
               [ config_place_avoidance.DATA_REPRESENTATION_ARENA_COORD, ...
                 ...
                 config_place_avoidance.DATA_REPRESENTATION_ARENA_ANGULAR_SPEED_PROFILE, ...
               ...
               'FeatureSet', feat, ...
               'ClusteringFeatureSet', feat_clus, ...               
