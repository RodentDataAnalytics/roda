classdef clustering_view < handle
    ...
    methods
        ...
        function cluster_callback(inst, source, eventdata) 
            ...
            classif = inst.parent.traj.classifier(inst.parent.labels_filename, inst.parent.features_cluster, inst.parent.config.TAG_TYPE_BEHAVIOUR_CLASS, [], inst.num_features);                
